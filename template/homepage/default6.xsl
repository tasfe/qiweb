	...
	<xsl:template match="/">
		<html>
			...
			<head>
				...
				<link href="/template/homepage/css/default6.css" rel="stylesheet" type="text/css" media="all"/>
			</head>
			<!--head完成-->		
			<body>
				<div class="page-body">
				...
				<div class="page-content">
					<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" width="700" height="300">
					  <param name="movie" value="/template/homepage/flash/7.swf"/>
					  <param name="quality" value="high"/>
					  <embed src="/template/homepage/flash/7.swf" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="700" height="300"></embed>
					</object>				
				</div>
				<div class="page-foot">
