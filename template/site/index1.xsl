...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format">
	...
	<xsl:template match="/">
		<html>
			...
			<head>
				...
				<link href="template/site/css/index1.css" rel="stylesheet" type="text/css" media="screen"/>
				<!-- 打印时候使用的样式表 -->
			...
			<body>
				<div class="page-title">
					...
					<xsl:if test="page/site_logo!=''">
						<div class="site-logo"><a href="default.asp"><img src="{page/site_logo}" alt="{//site_name} LOGO"/></a>
							<div class="flash-musk">
								<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" width="100" height="100">
								  <param name="movie" value="template/site/flash/4.swf"/>
								  <param name="quality" value="high"/>
								  <param name="wmode" value="transparent"/>
								  <embed src="template/site/flash/4.swf" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" wmode="transparent" width="100" height="100"></embed>
								</object>	
							</div>
						</div>
					</xsl:if>
				...
				<div class="page-search">
					<form action="index.asp" name="search_form" method="get">
						<xsl:value-of select="/page/language_pack/text_product_search"/>:<input name="keyword" id="keyword" type="text"/><input type="image" src="template/site/images/1/search.jpg" name="action" value="search"/>
					</form>
				</div>
				<div class="page-body">
					<div class="body-left">
					...
					<div class="body-right">
						...
						<div class="page-xp">
							<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" width="580" height="84">
							  ...
							  <param name="quality" value="high"/>
							  <param name="wmode" value="transparent"/>
							  <embed src="template/site/flash/1.swf" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" wmode="transparent" type="application/x-shockwave-flash" width="580" height="84"></embed>
							</object>	
						</div>
						</xsl:if>	
	...
	<xsl:template name="search_list">
		<div class="article-title"><h1>
			<xsl:if test="count(//keyword)!=0">
				“<font color="red"><b><xsl:value-of select="//keyword"/></b></font>”<xsl:value-of select="/page/language_pack/text_search_result"/>
			</xsl:if></h1>
		</div>
		<!--调用分页-->
		<xsl:call-template name="page_nav">
	...
	<xsl:template name="login-form">
		<div class="body-left-title"><xsl:value-of select="/page/language_pack/text_passport"/></div>
		<table width="100%" border="0">
		<form name="login-form" method="post" id="login-form" action="login.asp">
		<tr>
		<th><xsl:value-of select="/page/language_pack/text_loginname"/></th><td><input type="text" name="user_name" value="" style="width:100;" /></td>
		</tr>
		<tr>
		<th><xsl:value-of select="/page/language_pack/text_password"/></th><td><input type="password" name="user_password" value="" style="width:100;" /></td>
		</tr>
		<tr>
		<td colSpan="2" align="center">
		<input type="submit" name="action" value="{/page/language_pack/text_login}"/>
		<input type="button" name="reg" value="{/page/language_pack/text_reg}" onclick="window.location='/reg.asp'" /></td>
		</tr>
		</form>
		</table>
	</xsl:template>
