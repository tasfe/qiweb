	...
	<xsl:template match="/">
		<html>
			...
			<head>
				...
				<link href="template/site/css/index8.css" rel="stylesheet" type="text/css" media="screen"/>
				<!-- 打印时候使用的样式表 -->
					...
					<div class="body-left">
						...
						<div class="page-xp">
							<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" width="100%" height="80">
							  ...
							  <embed src="/template/site/flash/flashbg-0010.swf" wmode="transparent" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="100%" height="80"></embed>
							</object>	
						</div>
						</xsl:if>
