...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format">
	...
	<xsl:template match="/">
		<html>
			...
			<head>
				...
				<link href="template/site/css/index6.css" rel="stylesheet" type="text/css" media="screen"/>
				<!-- 打印时候使用的样式表 -->
			...
			<body>
				<div class="page-title">
					...
					<xsl:if test="page/site_logo!=''">
						<div class="site-logo"><a href="default.asp"><img src="{page/site_logo}" alt="{//site_name} LOGO"/></a></div>
					</xsl:if>
					<!--网站广告-->
				...
				<div id="line">
					<div id="menu">
					<div class="left"><img src="template/site/images/6/pix.gif" height="1" width="1" alt="" /></div>
					<div class="middle"><img src="template/site/images/6/pix.gif" height="1" width="1" alt="" /></div>
					<div class="right"><img src="template/site/images/6/pix.gif" height="1" width="1" alt="" /></div>
					</div>
					<div id="menu1">
						<div class="left0"></div>
						<div class="left"></div>
						<div class="middle">
							...
							<div class="page-menu">
								...
								<xsl:for-each select="page/sitemap/pagename">
									<xsl:if test="page_id=/page/parent_page">
										<li id="active-link"><a href="index.asp?sitepage={page_id}"><span><xsl:value-of select="title"/></span></a></li>
									</xsl:if>
									<xsl:if test="page_id!=/page/parent_page">
							...
							<div class="middle2"><div class="middle3_l"></div><div class="middle3"></div><div class="middle3_r"></div></div>
							<!--搜索框架-->
							<div class="page-search">
								<form action="index.asp" name="search_form" method="get">
									<xsl:value-of select="/page/language_pack/text_product_search"/>:<input name="keyword" id="keyword" type="text"/><input type="submit" value="Search" id="submit" />
								</form>
							</div>
						</div>
						<div class="right"></div>
					...
					<div id="line03">
						<div id="line03_l"><img src="template/site/images/6/pix.gif" height="1" width="1" alt="" /></div>
						<div id="line03_m"><img src="template/site/images/6/pix.gif" height="1" width="1" alt="" /></div>
						<div id="line03_r"><img src="template/site/images/6/pix.gif" height="1" width="1" alt="" /></div>
					</div>
					<div id="line04">
						<div id="line04_l"><img src="template/site/images/6/pix.gif" height="1" width="1" alt="" /></div>
						<div id="line04_m">
							<!--语言选择按钮-->
							<div class="language-button">
							<span>
								<xsl:value-of select="/page/language_pack/text_language"/>：
								<xsl:for-each select="page/public_language/language_name">
									<a href="start.asp?language={@id}"><xsl:value-of select="."/></a>
								</xsl:for-each>
							</span>
							</div>
						</div>
						<div id="line04_r"><img src="template/site/images/6/pix.gif" height="1" width="1" alt="" align="middle" /></div>
					</div>
				</div>
			<div class="content">
				<div class="page-body">
					<div class="body-left">
						...
						<xsl:if test="//frame=''">
						<div class="page-xp">
							<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" width="580" height="84">
							  <param name="movie" value="/template/site/flash/1.swf"/>
							  <param name="quality" value="high"/>
							  <param name="wmode" value="transparent"/>
							  <embed src="/template/site/flash/1.swf" wmode="transparent" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="580" height="84"></embed>
							</object>	
						</div>
						</xsl:if>
						<!--正文底部广告代码-->
					...
					<div class="body-right">
						...
						<div class="page-nav">
							<div class="body-left-title"><xsl:value-of select="/page/language_pack/text_news"/></div>
						...
						<!--二级导航栏-->
						<div class="page-nav">
							<div class="body-left-title"><xsl:value-of select="/page/language_pack/text_nav"/></div>
							<ul>
								<xsl:for-each select="page/sitemap/pagename/sitemap/pagename">
									<xsl:if test="../../page_id=/page/parent_page">
										<xsl:if test="page_id=/page/cur_page">
											<li><a href="index.asp?sitepage={page_id}" id="nav-link"><xsl:value-of select="title"/></a></li>
										</xsl:if>
										<xsl:if test="page_id!=/page/cur_page">
											<li><a href="index.asp?sitepage={page_id}"><xsl:value-of select="title"/></a></li>
										</xsl:if>
									</xsl:if>
								</xsl:for-each>
							</ul>
						...
						<!--友情链接-->
						<div class="page-nav">
							<div class="body-left-title"><xsl:value-of select="/page/language_pack/text_link"/></div>
							<!--文字链接-->
							<span>
							<div class="text-link">
								<select style="width:100px;" name="text-link" onchange="if(this.options[this.selectedIndex].value!='null') window.open(this.options[this.selectedIndex].value,'','');">
									<option value="null">--<xsl:value-of select="/page/language_pack/text_link"/>--</option>
									<xsl:for-each select="page/linklist/link[link_logo='']">
										<option value="{link_url}" title="{link_desc}"><xsl:value-of select="link_name"/></option>
									</xsl:for-each>
								</select>
							</div>
							<!--图片链接-->
							<div class="logo-link">
								<xsl:for-each select="page/linklist/link[link_logo!='']">
								<a href="{link_url}" target="_blank"><img src="{link_logo}" alt="{link_desc}"/></a><br/>
								</xsl:for-each>
							</div>
							</span>
						</div>
				...
				<div class="page-foot"><span><span><xsl:value-of select="//foot_info" disable-output-escaping="yes"/></span></span></div>
				<!--页面底部广告代码-->
	...
	<xsl:template name="lyb">
		...
		<form action="lyb_save.asp" name="form1" method="post" id="lyb-form"><a name="ly"/>
			<table border="0" width="550px" cellpadding="4" cellspacing="0">
				<tr>
				...
				<tr>
					...
					<td><textarea name="lyb_content" class="inpt-text" style="width:400;height:80;">
						</textarea> *
					</td>
				</tr>
				<tr>
	...
	<xsl:template name="filelist">
		...
		<xsl:if test="count(page/software_list/software)=0">
			<div class="article-title"><h1><xsl:value-of select="page/sitemap/pagename/title[../page_id=//parent_page]"/>
				<xsl:if test="//parent_page!=//cur_page">
					>>
					<xsl:value-of select="page/sitemap/pagename/sitemap/pagename/title[../page_id=//cur_page]"/>
				</xsl:if></h1>
