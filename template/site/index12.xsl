...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format">
	...
	<!--统一调用页面的页头页尾模板-->
	<xsl:template match="/">
		<html xmlns:qiweb="http://qiweb.cn/">
			<!--调用统一的HEAD内容-->
			<head>
				...
				<link href="template/site/css/index12.css" rel="stylesheet" type="text/css" media="screen"/>
				<!-- 打印时候使用的样式表 -->
			...
			<qiweb:body-right-foot>
				...
				<div class="page-body">
					...
					<div class="body-right">
						...
						<xsl:if test="//frame=''">
						<div class="page-xp">
							<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" width="570px" height="110">
							  <param name="movie" value="template/site/flash/flashbg-0010.swf"/>
							  <param name="quality" value="high"/>
							  <param name="wmode" value="transparent"/>
							  <embed src="template/site/flash/flashbg-0010.swf" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" wmode="transparent" type="application/x-shockwave-flash" width="570px" height="110"></embed>
							</object>	
						</div>
						</xsl:if>
