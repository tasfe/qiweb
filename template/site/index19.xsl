	...
	<xsl:template match="/">
		<html>
			...
			<head>
				...
				<link href="template/site/css/index19.css" rel="stylesheet" type="text/css" media="screen"/>
				<!-- 打印时候使用的样式表 -->
				<link href="template/site/css/print.css" rel="stylesheet" type="text/css" media="print"/>
				<SCRIPT LANGUAGE="JScript" SRC="/template/site/images/19/menus.js"></SCRIPT>
			</head>
			<!--head完成-->		
			<body>
			<div class="content">
				...
				<div class="page-title">
					...
					<div class="language-button">
						...
						<xsl:value-of select="/page/language_pack/text_product_search"/>
							<input name="keyword" id="keyword" type="text"/><input type="image" src="template/site/images/19/search.gif" name="action" value="search"/>
						</form>
						</div>
						<!--语言选择按钮-->
						<span>
				...
				<xsl:if test="//frame=''">
				<div class="page-xp">
					<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" width="100%" height="145">
					  <param name="movie" value="/template/site/flash/flashbg-0010.swf"/>
					  <param name="quality" value="high"/>
					  <param name="wmode" value="transparent"/>
					  <embed src="/template/site/flash/flashbg-0010.swf" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="100%" height="145" wmode="transparent"></embed>
					</object>	
				</div>
				</xsl:if>
				</div>
				<div class="page-body">
					...
					<xsl:if test="count(//site_news)>0 or count(page/sitemap/pagename/sitemap/pagename[../../page_id=/page/parent_page])">
						<div class="body-left">
					...
					<xsl:if test="count(//site_news)>0 or count(page/sitemap/pagename/sitemap/pagename[../../page_id=/page/parent_page])">
					<xsl:attribute name="style">width:70%;border-left:2px outset #fff;</xsl:attribute>
					</xsl:if>
