...
<TITLE>ASP探针V1.93 (瑞星用户专用版)－阿江http://www.ajiang.net</TITLE>
<style>
<!--
...
%>
<h2>不安全组件检测</h2>
<p>这是瑞星用户专用版，因为此功能代码会被瑞星杀毒软件误报为木马病毒，因此此版本不包含安全检测功能。</p>
<p>如您确需此功能，请到以下网址下载完整版安装，<br />
<a href="http://www.ajiang.net/products/aspcheck/">http://www.ajiang.net/products/aspcheck/</a><br />
注意安装前停止服务器上瑞星的病毒监控，否则程序将被瑞星自动删除。</p>
<%
end sub
