...
FCKConfig.ToolbarSets["MyToolbar"]=[
    ['Source','Preview','Image','Flash','SpecialChar','-','Templates','Table','Rule','Smiley'],
	['Cut','Copy','Paste','PasteText','Bold','Italic','Underline','OrderedList','UnorderedList','-','Link','Unlink','Anchor'],
	['TextColor','BGColor','JustifyLeft','JustifyCenter','JustifyRight','JustifyFull'],
	['Undo','Redo','Find','Replace','SelectAll','RemoveFormat','-','Outdent','Indent','Style'],
	['FontFormat','FontName','FontSize'],
	['FitWindow','About']
] ;
FCKConfig.ToolbarSets["UfoToolbar"]=[
    ['Source','Preview','Image','Table','Rule','Smiley'],
	['TextColor','BGColor','JustifyLeft','JustifyCenter','JustifyRight','JustifyFull'],
