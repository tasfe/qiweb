	...
	<xsl:template match="/">
		<html>
			...
			<head>
				...
				<link href="template/site/css/index15.css" rel="stylesheet" type="text/css" media="screen"/>
				<!-- 打印时候使用的样式表 -->
			...
			<div class="content">
				...
				<xsl:if test="//frame=''">
				<div class="page-xp">
					<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" width="100%" height="135">
					  <param name="movie" value="/template/site/flash/flashbg-0020.swf"/>
					  <param name="quality" value="high"/>
					  <param name="wmode" value="transparent"/>
					  <embed src="/template/site/flash/flashbg-0020.swf" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="100%" height="135" wmode="transparent"></embed>
					</object>	
				</div>
				</xsl:if>
				<div class="page-body">
					<div class="body-left">
						...
						<div class="page-nav">
							...
							<form action="index.asp" name="search_form" method="get">
								<input name="keyword" id="keyword" type="text"/><input type="image" src="images/go.gif" name="action" value="search"/>
							</form>
							</div>
						</div>
						<!--二级导航栏-->
	...
	<xsl:template name="product">
		...
		<xsl:if test="count(page/product_list/product)=1">
			<xsl:for-each select="page/product_list/product">
				<div class="product-title"><xsl:value-of select="/page/language_pack/text_product_name"/><strong><xsl:value-of select="title"/></strong></div>
	...
	<xsl:template name="filelist">
		...
		<xsl:if test="count(page/software_list/software)=1">
			<xsl:for-each select="page/software_list/software">
				<div class="product-title"><xsl:value-of select="/page/language_pack/text_software_name"/><strong><xsl:value-of select="title"/></strong></div>
				<div class="product-pic">
					<xsl:if test="pic!=''">
	...
	<xsl:template name="movie">
		...
		<xsl:if test="count(page/movie_list/movie)=1">
			<xsl:for-each select="page/movie_list/movie">
				<div class="product-title"><xsl:value-of select="/page/language_pack/text_movie_name"/><strong><xsl:value-of select="title"/></strong></div>
				<div class="product-pic">
					<xsl:if test="pic!=''">
						<a href="{pic}" target="_blank">
						<img src="{pic}" alt="{title}" width="200px"/>
