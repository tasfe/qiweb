	...
	<xsl:template match="/">
		<html>
			...
			<head>
				...
				<link href="template/site/css/index3.css" rel="stylesheet" type="text/css" media="screen"/>
				<!-- 打印时候使用的样式表 -->
					...
					<div class="body-left">
						...
						<div class="page-search">
							<form action="index.asp" name="search_form" method="get">
								<xsl:value-of select="/page/language_pack/text_product_search"/>:<input name="keyword" id="keyword" type="text"/><input type="submit" value="Search" class="submit" />
							</form>
						</div>
