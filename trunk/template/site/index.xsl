	...
	<xsl:template match="/">
		<html>
			...
			<head>
				...
				<link href="template/site/css/index.css" rel="stylesheet" type="text/css" media="screen"/>
				<!-- 打印时候使用的样式表 -->
			...
			<body>
				...
				<div class="page-xp">
					<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" width="450" height="150">
					  ...
					  <embed src="template/site/flash/1.swf" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" wmode="transparent" width="450" height="150"></embed>
					</object>	
				</div>
				</xsl:if>	
				<!--菜单-->
				<div class="page-menu">
					...
					<xsl:for-each select="page/sitemap/pagename">
						<xsl:if test="page_id=/page/parent_page">
							<li><a href="index.asp?sitepage={page_id}" id="active-link"><xsl:value-of select="title"/></a></li>
						</xsl:if>
						<xsl:if test="page_id!=/page/parent_page">
				...
				<div class="page-body">
					<div class="body-left">
						...
						<div class="body-left-title"><span>
							<xsl:value-of select="/page/language_pack/text_language"/></span>
						</div>
						<span>
						...
						<!--搜索框架-->
						<div class="language-button">
							<div class="body-left-title"><span><xsl:value-of select="/page/language_pack/text_product_search"/></span></div>
						...
						<!--二级导航栏-->
						<div class="language-button">
							<div class="body-left-title"><span><xsl:value-of select="/page/language_pack/text_nav"/></span></div>
							<div class="page-nav">
							<ul>
						...
						<!--友情链接-->
						<div class="language-button">
							<div class="body-left-title"><span><xsl:value-of select="/page/language_pack/text_link"/></span></div>
							<!--文字链接-->
							<span>
							<div class="text-link">
					...
					<div class="body-right">
						<img src="template/site/images/xt.gif" alt="welcome"/>
				...
				<div class="page-foot"><xsl:value-of select="//foot_info" disable-output-escaping="yes"/>
	...
	<xsl:template name="album">
		...
		<xsl:for-each select="page/album_list/album">
			<div class="album_list">
				<a href="{pic}" rel="lightbox[qiweb]" title="{title}{content}" target="img">
				<!--根据系统设置，设置图片的大小-->
				<xsl:if test="//para_pic_width='' and //para_pic_height=''">
