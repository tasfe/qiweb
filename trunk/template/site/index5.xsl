	...
	<xsl:template match="/">
		<html>
			...
			<head>
				...
				<link href="template/site/css/index5.css" rel="stylesheet" type="text/css" media="screen"/>
				<!-- 打印时候使用的样式表 -->
				...
				<div class="page-title">
					...
					<div class="page-menu">
						...
						<xsl:for-each select="page/sitemap/pagename">
							<xsl:if test="page_id=/page/parent_page">
								<li id="active-link"><a href="index.asp?sitepage={page_id}"><xsl:value-of select="title"/></a></li>
							</xsl:if>
							<xsl:if test="page_id!=/page/parent_page">
					...
					<div class="page-search">
						<form action="index.asp" name="search_form" method="get">
							<xsl:value-of select="/page/language_pack/text_product_search"/>:<input name="keyword" id="keyword" type="text"/><input type="submit" value="GO" class="submit" />
						</form>
					</div>
					</div>
					<!--网站广告-->
					...
					<div class="body-left">
						...
						<div class="page-xp">
							<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" width="100%" height="80">
							  <param name="movie" value="/template/site/flash/flashbg-0016.swf"/>
							  <param name="quality" value="high"/>
							  <param name="wmode" value="transparent"/>
							  <embed src="/template/site/flash/flashbg-0016.swf" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="100%" wmode="transparent" height="80"></embed>
							</object>	
						</div>
						</xsl:if>
